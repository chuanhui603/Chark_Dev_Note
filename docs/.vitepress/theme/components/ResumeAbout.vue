      ...
      <div class="resume-header">
        <aside class="resume-profile">
          ...
          <ul class="resume-contact-list">
            ...
            <li v-if="fm.language">
              <span class="resume-contact-icon" v-html="icons.language"></span>
...
const icons = {
  ...
  language: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" width="18" height="18"><circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>',
